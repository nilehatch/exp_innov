...
::: {.key-action}
**Ground rules for the whole diamond**
...
### 6-3-5 Brainwriting {.method-header}
...
::: {.see-guide}
The practical notes on running a session — adjusting the numbers, keeping the sheets, debriefing after rather than during — are in [Solution Guides](toolkit/Solution_Guides.qmd#sec-generate).
:::
...
### Deliberately Bad Ideas {.method-header #sec-bad-ideas}

Before the generating starts, have everybody bring one: the worst thing they could possibly build. Not a weak idea or a boring one. Something actively bad, and bad in one of two specific ways: it cannot be built at all, or, better, **it makes the pain worse**.

This sounds like a game and it is one. It is also the most reliable way to break the thing that stops teams generating.

**It removes the pressure that kills divergence.** The rule everyone agrees to and nobody manages is *suspend judgment*. Ask for a good idea and people edit before they speak. Ask for a terrible one and there is nothing left to suppress, and the quiet members of a team are usually the first to get funny.

**Making the pain worse requires understanding the pain.** To design something that makes a difficulty genuinely worse, you have to know what produces it. That makes this a test disguised as a game: a team that cannot invent a way to make their people's lives worse does not yet understand what makes them hard. If the round produces nothing, go back to your experience map rather than pressing on.

**Seed them at the start rather than saving them for a round.** A bad idea written late has a round or two left to be built on. The same idea written first has the whole session, and it spends it going round the table being answered.

**It puts cards in the catalog from a region nobody visits.** The bad ideas are far from where you have been searching, which is exactly what makes them useful raw material for the next round of recombination. Take the worst one and invert a single attribute, or ask what would have to be true for it to be good. That question has a habit of producing something usable.

You do not need to protect the funnel from these. A concept that harms your people scores minus against the reference on every requirement and dies in the first screening. What survives is never the bad idea itself; it is the mechanism you noticed while building it.

::: {.mini-case}
The Halo Alert team produced one without meaning to. Among their candidate solutions for women walking home after dark was **electrified clothing** that would shock an assailant.

The women they described it to were alarmed, and for reasons the team had not considered: an assailant could take it and use it on them, or they might shock a friend by accident. The idea was eliminated immediately, as it should have been.

But it did two things on the way out. It produced two market requirements that had not existed before anyone proposed anything — *not usable against me* and *not dangerous to bystanders* — and it generated ideas about making the alert ring more discreet and more wearable. A bad idea, killed in screening, left the surviving concept better than it found it.
:::

### SCAMPER {.method-header}
...
The value is not any single prompt. It is that the checklist forces you past the pairings you would have found on your own, manufacturing the collisions that serendipity would otherwise have to supply.

### Systematic Inventive Thinking {.method-header #sec-sit}

SIT is the more disciplined cousin, and it is aimed squarely at *elegance*. Where SCAMPER opens options, SIT works inside the constraints of the thing in front of you. Subtraction removes an indispensable component and asks what the remainder is good for; task unification makes one element do a second job.[^sit] The results tend to be leaner solutions rather than more elaborate ones, which matters because the elegant solution is usually the buildable one.

[^sit]: For detail on Systematic Inventive Thinking, see @goldenbergFindingYourInnovation2003 and @boydBox2013.

The reversal SIT depends on is that you build the strange object first and ask what it is for second.
...
::: {.see-guide}
The five templates and the procedure for running them are in [Systematic Inventive Thinking](toolkit/Solution_Guides.qmd#sec-sit-guide).
:::

### Serendipity Favors a Full Catalog

Some recombinations arrive unbidden, as an accidental discovery made while looking for something else.[^3] Serendipity is not the opposite of method; it is what method makes likely. A full catalog and a question you are actively holding produce more accidents than an empty catalog and no question.
...
That pool is the whole point. An innovator who fixates on a single idea is making a low-probability bet and usually does not know it, because the idea feels compelling precisely because there is nothing beside it for comparison. Breadth is what makes the next chapter's screening meaningful, and screening is what turns a pool into a choice.
