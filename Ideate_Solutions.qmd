...
The five templates and the procedure for running them are in [Solution Guides](toolkit/Solution_Guides.qmd#sec-sit-guide); the reversal they depend on is that you build the strange object first and ask what it is for second. You will meet SIT again in the next chapter. Screening does not only eliminate concepts — it reveals which *features* of the losing concepts outperformed, and those features are exactly what recombination is for. That is the loop back into this move, and it is one of the most productive rounds you will run.
