...
<!-- <img src="images/231_solution_diverge.svg" alt="Divergent ideation to obtain many solution ideas." class="wrapfig_left_25"/> -->
![Divergent ideation to obtain many solution ideas.](images/231_solution_diverge.svg){.print-w-25 .wrapfig_right_25}
...
### Recombine Cards and Think Associatively  {.unnumbered}
...
<!-- Claude 2026-07-30: the previous sentence claimed the iPod click wheel WAS developed by
combining a padlock dial with a music player. That origin story is widely repeated but I
could not source it, so the causal claim is removed and the pairing is now offered as an
illustration rather than a history. Restore the original if you have a source you trust. -->
One approach is to select two random objects or concepts and explore potential connections. Pair a padlock's dial with a digital music player and you are not far from Apple's iPod click wheel. Forced pairings work because they push you out of the categories you already think in.
...
### Measuring Creativity  {.unnumbered}
...
### Effective Brainstorming Techniques  {.unnumbered}
...
### Maximizing Brainstorming Outcomes  {.unnumbered}
