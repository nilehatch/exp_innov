...
## Feasibility Filter: The First Line of Defense {#sec-feasibility-filter}
...
## Dot Voting: Harnessing Team Passion and Insight {#sec-dot-vote}
...
## Screening Matrix: Filtering for the Best Ideas {#sec-screening-matrix}
...
#### Where Those Requirements Actually Come From {#sec-where-requirements .unnumbered}
...
::: {.see-guide}
Building the matrix step by step, with an empty template and the five-point scoring variant, is in [Screening matrix](toolkit/Solution_Guides.qmd#sec-screening).
:::
...
::: {#tab:screening-matrix .worksheet}
...
::: {.see-guide}
The convergence filters — feasibility, dot voting, the screening matrix, and SIT applied to what survives — are in [Solution Guides](toolkit/Solution_Guides.qmd#sec-solution-converge).
:::
...
### Enhancing Solutions with Systematic Inventive Thinking (SIT) {#sec-sit-enhance}
...
::: {.see-guide}
The five templates and the procedure, with the closed-world rule that keeps the results buildable, are in [Systematic Inventive Thinking](toolkit/Solution_Guides.qmd#sec-sit-guide).
:::
...
Pauling's rule was that you must have many ideas to have good ones, and he finished the thought by saying that what you have to learn is which of them to throw away [@paulingImpactLinusPauling1995]. That second half is this chapter's work, and the part worth remembering is that throwing away is not the same as choosing. You have thrown away. The choosing happens when these concepts meet people who did not help you make them.
