...
The last column is the one that does the work. If you cannot produce something a person actually said, the requirement is yours rather than theirs, and it goes in marked as an assumption rather than quietly promoted. Assumptions are allowed here. Unmarked ones are how a matrix eliminates a good idea *for a reason nobody ever held*.
