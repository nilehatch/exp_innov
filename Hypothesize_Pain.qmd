# Hypothesize Customer Pain {#sec-hypothesize-pain-chapter}

#### Convergence through empathy tools to hypothesize an unknown, unmet need (pain) in the lives of your people {.subtitle}
...
![Convergent synthesis of data to reach informed hypotheses of customer pain.](images/221_pain_diverge.svg){.wrapfig_left_25}
...
::: callout-note  
**See the Demo**  
In the Halo Alert demo, you’ll see how dozens of raw quotes and notes from interviews were clustered into themes about safety during evening commutes. Watch how the noise of scattered observations turns into patterns you can actually work with.  
:::  
...
Why bother? Because it’s hard to empathize with “a cluster of notes.” It’s much easier to imagine the daily life of *Brooke, a 19-year-old college student who walks home after late classes and feels a knot of anxiety on dark streets.* Personas take abstract patterns and make them human again. They help you imagine how a real person thinks, feels, and acts when they bump into unmet needs.  
...
::: callout-note  
**See the Demo**  
The Halo Alert demo shows how themes can be personified in a vivid persona — Brooke Hatch. Brooke is an archetypal composite built from more than a hundred conversations with professional women who walk as part of their commute— a living character who makes the patterns concrete.  
:::  
...
::: callout-note  
**See the Demo**  
In the Halo Alert demo, Brooke’s journey commuting from work to home is mapped stage by stage. The map shows where her anxiety spikes and how her family becomes involved in the stress — surfacing multiple candidate pains to explore further.  
:::  
...
::: callout-note  
**See the Demo**  
The Halo Alert demo takes those candidate pains and runs them through abductive reasoning: drafting, comparing, and refining until one pain hypothesis stands out as most urgent and testable.  
:::  
...
::: {.callout-note icon = false title = "Gillette in India"}
...
Exploration gave you breadth. Convergence gave you depth. Now you have a handful of well-formed hypotheses about the pains your people actually live with. The next step is to test them — to find out which ones are real, urgent, and worth solving.  
