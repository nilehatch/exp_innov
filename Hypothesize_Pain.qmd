...
Thin clusters usually are not a failure of clustering. They are the first visible evidence that the group you chose is *actually several groups*. That is the failure mode [Commit to a Community](Choose_People.qmd) warned about, and this is where it surfaces, because pains sort by person and these ones will not sort at all.
