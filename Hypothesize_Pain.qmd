...
::: {.see-demo}
In the [Halo Alert demo of clustering into themes](demo/halo-alert-d2-converge.qmd#sec-ha-cluster), dozens of raw quotes and notes from interviews are clustered into themes about safety during evening commutes. Watch the noise of scattered observations turn into patterns you can work with.
:::
...
::: {.see-demo}
The [Halo Alert demo of developing personas](demo/halo-alert-d2-converge.qmd#sec-ha-persona-maya) shows how themes become a vivid persona, Maya Patel. Maya is an archetypal composite built from more than a hundred conversations with professional women who walk as part of their commute.
:::
...
::: {.see-demo}
In the [Halo Alert demo of experience mapping](demo/halo-alert-d2-converge.qmd#sec-ha-expmap), Maya's journey home is mapped stage by stage. The map shows where her anxiety spikes and how her family becomes drawn into the stress, surfacing several candidate pains at once.
:::
...
::: {.see-demo}
The [Halo Alert demo of hypothesizing pain](demo/halo-alert-d2-converge.qmd#sec-ha-abduction) takes candidate pains through abductive reasoning, drafting and comparing and refining until one stands out as most urgent and testable.
:::
...
All three, or it goes back. The third is what separates a hypothesis from a hunch you have grown attached to.
:::
