...
This guide should be used with the methods outlined in the [Experience Mapping](../Hypothesize_Pain.qmd#sec-experience-map-section) section of *Hypothesize Customer Pain*.
...
In the [Halo Alert demo of experience mapping](../demo/exp-08.a-experience-map-2025-03-14.qmd), Maya’s journey to and from work is mapped step by step. You’ll see where her anxiety spikes, how her family becomes entangled in the stress, and how multiple candidate pains surface from a single routine walk.  
