...
| [Converge — Narrow to One](#sec-solution-converge) | [Feasibility filter](#sec-feasibility) · [Dot voting](#sec-dot-voting) · [Screening matrix](#sec-screening) · [SIT](#sec-sit-converge) |
...
Unlike the other two diamonds, Diamond 3 never had guides: its methods were written into the chapters and stayed there. So these pages are being **extracted from** the chapters rather than written beside them, and the extraction is partway done. Divergence is complete here, SIT included, and smoke testing has its procedure. Convergence and the other six tests name every method and what each one asks, and the chapters still carry them in full. Follow the links. [The Method Layer](../method-layer.qmd) stops at the end of Diamond 2.
...
Four filters, applied in order from cheapest to most deliberate.

#### Feasibility filter {#sec-feasibility}

A first pass that removes what cannot be built, afforded, or legally sold by a team like yours. Chapter: [Feasibility Filter](../Hypothesize_Solution.qmd#sec-feasibility-filter). Cheap, fast, and applied before anything more careful, so the careful work runs on a shorter list. *Procedure pending; the chapter carries it today.*

#### Dot voting {#sec-dot-voting}

Surfaces where team conviction actually sits, which is information about your team rather than about your customers. Useful as a tiebreaker and as a way to see disagreement early. Chapter: [Dot Voting](../Hypothesize_Solution.qmd#sec-dot-vote). It is not evidence, and the guide will say so once it carries the steps. *Procedure pending.*

#### Screening matrix {#sec-screening}

The main instrument. Candidates rated plus, zero or minus against a **reference solution** on unweighted market requirements, then netted. It is built to *eliminate* rather than to rank, and the requirements it runs on are provisional on the first pass. Chapter: [Screening Matrix](../Hypothesize_Solution.qmd#sec-screening-matrix). See [Where those requirements come from](../Hypothesize_Solution.qmd#sec-where-requirements) for why. *Procedure pending.*

#### Systematic Inventive Thinking {#sec-sit-converge}

Returns here, applied to the requirements your surviving concepts scored well on, to improve what survived rather than merely rank it. The five templates and the procedure are in the divergence phase above, at [Systematic Inventive Thinking](#sec-sit-guide).
