...
*24 February to 8 March.* Twelve conversations and three observation outings, from a community the team had just proved it could reach.
...
- **Introduction:**  
  “Hi, my name is [your name]. I’m working on a project to better understand people’s commuting experiences. I’m not selling anything — I’d just love to hear your perspective. The conversation will take 15–20 minutes. Is it okay if I ask a few questions, and possibly record for accuracy?”  
...
- **Document:** Store the transcript and notes as a full record, unknown through next steps.  
...
Hello, my name is [your name]. I’m working on a project about [general problem space].  
...
- If someone hesitates, reassure them: *“We’re not selling anything. We’re trying to understand how this works for people.”*  
- Respect refusals immediately — thank them for their time.

## Conversations {#sec-ha-conversations}

Twelve in all, over two weeks. Two are reproduced below in full, because a complete transcript shows things a summary cannot: the questions that went nowhere, the places the interviewer talked too much, the answer that only arrived on the third attempt. The other ten survive as notes and quotes, which is the ordinary ratio and the reason the clustering has more voices in it than these two pages do.
...
**Attribution:** Observation conducted by Dana as part of the Halo Alert exploratory research series (Diamond 2).
