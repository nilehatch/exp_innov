...
# Opening & Rapport
**Interviewer:** Thank you for taking a moment to speak with me tonight. My name is Dana, and I’m learning from commuters about their everyday experiences. Could you please tell me your name?  
...
::: {.fieldnote}
Darkness + sparsity heighten unease; chooses sensory alertness (no headphones).  
:::
...
::: {.fieldnote}
Trade-off between crowd comfort vs. exposure; somatic cues (sounds louder); protective tactics.  
:::
...
::: {.fieldnote}
Vulnerability rooted in lack of bystanders or witnesses; anticipatory fear.  
:::
...
::: {.fieldnote}
Behavioral adaptations: lighting preference, defensive posture, exit strategy.  
:::
...
::: {.fieldnote}
Past incident nearby produces durable behavioral change; prioritizes reassurance over convenience.  
:::
...
::: {.fieldnote}
Value trade-off: time vs. psychological safety. Anxiety itself framed as cost.  
:::
...
::: {.fieldnote}
Connection ritual; accountability loop; shared location as safety proxy.  
:::
...
::: {.fieldnote}
Density flips valence: crowd = relief at night, crowd = nuisance by day.  
:::
