...
- **Interviewer:** Dana  
- **Consent:** Verbal consent to a ~20-minute recorded conversation for a research project; no sales intent.
...
# Opening & Rapport
**Interviewer:** Good morning, thank you so much for agreeing to speak with me today. My name is Dana, and I'm exploring the experiences of commuters in urban settings. May I have your name, please?

**Sarah:** Good morning, Dana. I'm Sarah Thompson.
...
::: {.fieldnote}
Left later (8:30 AM); sunny, lively streets; uses podcasts to create personal space; typical rush-hour crowds; slight delay due to roadblock; overall positive mood despite minor disruption.
:::
...
::: {.fieldnote}
Routine disruption → frustration; uncertainty about detour → anxiety; prefers known routes; mental load of “recalibration” under time pressure; detour minor but psychologically salient.
:::
...
::: {.fieldnote}
High-density crowds; vigilance over space and belongings; “individual isolation” amid proximity; practiced readiness to board/alight.
:::
...
::: {.fieldnote}
Heightened alertness (somatic cues like quickened pulse); proactive bag control; constant monitoring; tension peaks with jostling or surprises.
:::
...
::: {.fieldnote}
Discomfort is situational (overcrowding), not geographic; exit anxiety; vigilance spikes with density.
:::
...
::: {.fieldnote}
Adaptation and optimization; familiarity lowers baseline anxiety; micro-strategies to manage density.
:::
...
::: {.fieldnote}
Off-peak sparsity → eeriness and entrapment feeling; lighting is a strong moderator of perceived safety; seeks visibility and crowds for reassurance.
:::
...
::: {.fieldnote}
“Safety through connection” routine; lightweight protocol with accountability; boosts perceived control.
:::
...
::: {.fieldnote}
Intent is safety-first; companionship effect reduces vulnerability.
:::
...
::: {.fieldnote}
Time-of-day and density are key moderators; meaningful “cognitive tax” of vigilance (10–15 min/25).
:::
...
---
**Attribution:** Interview conducted by Dana as part of the Halo Alert exploratory research series (Diamond 2).
