...
Each stage pairs a chapter with its tools:

- **Chapter** — the *why*, the judgment, and the traps.
- **Guide** — the steps, in [Pain Guides](toolkit/Pain_Guides.qmd).
- **Demo** — the Halo Alert team's real application: unfiltered notes, transcripts, and synthesis from the field.
- **Your AI** — the sorting, drafting and cross-checking, once you have gathered the evidence. It cannot gather it.

Together these give you both the reasoning and the practice to hypothesize customer pain with confidence.
:::
