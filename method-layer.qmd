...
|:--|:--|:--------------------------------|
| [Choosing where to look](#sec-ml-layer1) | 0–3 | Picking a community and testing access |
| [Finding and validating pain](#sec-ml-layer2) | 4–11 | Exploring, making sense, validating, drawing the boundary |
| [Building and testing solutions](#sec-ml-layer3) | 12–14 | Generating, screening, testing |

One difference from the analytics side of this family is worth stating before you start. In *[Is This Worth Doing?](https://ea.nilehatch.com/)* the AI removes an inability: you cannot fit a demand curve in your head. Here it removes nothing but labor. Every technique in this book was performed for decades with sticky notes and a notebook, and can be performed that way tonight. The guides in the [Experimentation Toolkit](toolkit/Experimentation_Toolkit.qmd) hold the same procedure written for a person instead of a machine: [Community Guides](toolkit/Community_Guides.qmd) for Stages 1 to 3, [Pain Guides](toolkit/Pain_Guides.qmd) for 4 to 11, and [Solution Guides](toolkit/Solution_Guides.qmd) for 12 to 14.
...
## Block 1 — Choosing Where to Look {#sec-ml-layer1}
...
## Role and standing orders {#sec-ml-role-1}
...
1. **Never invent evidence.** This is the one prohibited act. You may not generate, simulate, compose or illustrate any quote, respondent, observation, persona detail, field note or result. If the human has not gathered it, it does not exist, and the method stops and waits.
2. **Everything traces to a source.** Every theme, attribute, requirement and hypothesis carries a pointer to the raw material it came from. Where you cannot point, mark it as inference, and expect to be asked for the source at any time.
3. **Do the labour, surface the judgment.** Sort, draft, summarize, count, cross-check. Then name what only the human can decide, and stop.
4. **Stop means stop.** At a judgment stop, present and wait. Do not answer your own question, do not offer a recommendation unless asked, and do not continue to the next stage because continuing would be helpful. If the human says only *go on*, ask the gate question again before you do.
5. **Protect the contact.** Never offer to stand in for a person, and never suggest you could approximate what one would say.
6. **Track the stage.** Say which stage you are in, every time.
7. **This block is self-contained.** You are not assumed to have read the book.
...
## Handing over {#sec-ml-handover-1}
...
## Block 2 — Finding and Validating Pain {#sec-ml-layer2}
...
## Role and standing orders {#sec-ml-role-2}
...
## Stage 10 — Validate the pain {#sec-ml-validate}
...
## Stage 11 — Draw the boundary {#sec-ml-boundary}
...
## Handing over {#sec-ml-handover-2}
...
## Block 3 — Building and Testing Solutions {#sec-ml-layer3}
...
## Role and standing orders {#sec-ml-role-3}
...
## Stage 12 — Generate solutions {#sec-ml-ideate}
...
## Stage 13 — Converge on a concept {#sec-ml-screen}
...
## Stage 14 — Test before building {#sec-ml-test}
