...
Some examples of the shape you are looking for: food insecurity in mid-sized cities, the burden of caregiving for aging parents, housing instability for gig workers, safety on a walk home after a late shift, the quiet pressures on first-generation college students.

Notice what those have in common. Each names a *situation people live in*, not a product category and not a problem someone has already solved. "Better project management software" is a solution wearing a problem's clothes. "The chaos of coordinating volunteers across three shelters that share a van" is a place you could go and look.
...
::: {.reflect}
**Prompts for Community Generation**
...
A **community**, here, is a set of people shaped by the same constraints. Not the same census box. What they share is the pressures, the workarounds, and the things that make a Tuesday hard. When you can say *these people all have to deal with X*, you have a group. When all you can say is *these people are all between 25 and 34*, you have a demographic, and demographics do not have pains.

The test is quick: could you write one sentence describing a bad day that most of this group would recognize? If not, the group is too broad.
...
Use the [divergence sprint](toolkit/Community_Guides.qmd#sec-community-diverge) from the toolkit to widen the net you cast in search of neglected or disenfranchised communities. Before you commit to any of them, set your candidates beside the [Community Choice Gallery](toolkit/Community_Choice_Gallery.qmd), which shows what too broad and too narrow each cost you later. Also review the [Halo Alert Demo](demo/halo-alert-d1-choose.qmd#sec-ha-d1-diverge) to see how a team kept expanding their focus on commuters.
...
Which communities seem most overlooked? Which live with friction that the established firms ignore, and that nobody else is already rushing to fix? Which are observable and reachable in practice?
