...
Use the [divergence sprint](toolkit/Community_Guides.qmd#sec-community-diverge) from the toolkit to widen the net you cast in search of neglected or disenfranchised communities. Before you commit to any of them, set your candidates beside the [Community Choice Gallery](toolkit/Community_Choice_Gallery.qmd), which shows what too broad and too narrow each cost you later. Also review the [Halo Alert Demo](demo/exp-01-diverge-people-2025-02-19.qmd) to see how a team kept expanding their focus on commuters.
