...
That second question has two versions, and the difference between them decides who can play. A solution is **within reach** when nobody has built it yet but everything needed to build it already exists: Amazon's one-click ordering had never been done, and the programming and the internet were sitting right there waiting. A solution is **beyond reach** when somebody first has to discover something new. Self-driving cars needed sensors and control systems that did not exist, and no amount of cleverness with existing parts would have produced them.
...
We will return to this with a picture of how competitors crowd the middle and leave the edges open, in @fig-tyranny-market in the *Choosing Your People* part.
