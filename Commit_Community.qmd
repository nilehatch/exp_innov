...
Remember that you are not naming your customers. That group is defined by a shared pain, and you do not know the pain yet; once you do, your people are whoever carries it, and [From Community to People](toolkit/Pain_Guides.qmd#sec-boundary) is how you draw that boundary when the time comes. If you did the work of divergence well you now have several promising communities in view, and the goal is not to pick the one you like most or the one that feels most familiar. It is to choose the community where a real pain is most likely to surface, and where you can get close enough to see it.
...
*For an example of how this looks in practice, see the [Compare section](demo/halo-alert-d1-choose.qmd#sec-ha-people-converge-compare) of the Halo Alert demo.*
...
*For an example of how this looks in practice, see the [Empathize section](demo/halo-alert-d1-choose.qmd#sec-ha-people-converge-empathize) of the Halo Alert demo.*
...
This is an assessment, not yet a test. You are making a judgment from your desk about whether access looks plausible, so that you do not commit to a group that is obviously unreachable. The next chapter turns that judgment into evidence by actually trying. Skip the assessment and you waste a week. Treat the assessment *as* the evidence and you waste a month.
...
*For an example of how this looks in practice, see the [Assess Access section](demo/halo-alert-d1-choose.qmd#sec-ha-people-converge-access) of the Halo Alert demo.*
...
Use the [convergence guide](toolkit/Community_Guides.qmd#sec-community-converge) from the toolkit to work through this decision with your team, and review the [Halo Alert Demo](demo/halo-alert-d1-choose.qmd#sec-ha-d1-converge) to see how another team narrowed its options and chose its people.
