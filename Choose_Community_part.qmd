# Choose Where to Look {#part-choose-community}
...
The hand-over happens at a specific moment rather than gradually: once a pain is validated, your people are whoever carries it, and the boundary can be drawn from the evidence you collected. The procedure for drawing it is [From Community to People](toolkit/Pain_Guides.qmd#sec-boundary), at the end of the pain guides. It is worth reading now, because knowing what the community is eventually *for* changes how you choose one.
...
The strategic version of this observation is well known: **blue ocean strategy** urges firms to leave contested space and create demand where there is none [@kimBlueOceanStrategy2005]. The economics underneath is the same one. What differs is altitude. That argument is made about industries and market boundaries, and this one is made about a particular set of people you could go and meet this week, which is the only height at which an entrepreneur without a strategy department can actually act.
...
What it does not promise is that you can get to the people who carry those needs, or that any need you find is one you could actually relieve. Those are different questions, and they are what this diamond and the next are built to answer. Whether the answer is worth a business at all is a further question still, and it belongs to [*Is This Worth Doing?*](https://ea.nilehatch.com/).

The abundance of unmet need is what makes the search worth starting. It says nothing about where the search ends.
...
That emphasis on what you already have will be familiar if you have met **effectuation**, which holds that expert entrepreneurs begin from means rather than goals: who they are, what they know, and whom they know [@sarasvathyCausationEffectuationTheoretical2001]. This diamond agrees about the starting point, because access is exactly that kind of means. It parts company over what is allowed to emerge. Effectuation lets the goal take shape from whoever commits; an expedition lets the *people* take shape from the pain, and insists the pain be found on purpose rather than arrived at.
...
Each stage (diverge, converge, test) comes with more than a chapter:

- **Chapter** — the *why*, the judgment, and the traps. Read this.
- **Guide** — a step-by-step worksheet for the parts you do by hand.
- **Demo** — how the Halo Alert team actually did it, with their real evidence.
- **Your AI** — increasingly, the drafting and the sifting. It can widen a list of candidate communities, profile a dozen of them in an afternoon, and tell you what it could not find. It cannot go and meet anybody, and that limit is doing more work than it looks like.

The chapter teaches, the guide directs, the demo proves it is doable, and your AI does the part that is labour rather than judgment.

Do not stop at reading. The one thing none of these four can do for you is walk into a room where your people are.
:::
