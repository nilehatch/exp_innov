...
Before moving on, run one yourself. Use the [Access Test Guide](toolkit/People_Guides.qmd#sec-people-test) to design and run a quick access check with your chosen group, and see how the Halo Alert team confirmed access in their [Access Test Demo](demo/exp-03-access-test.qmd).
