...
You have chosen a group of people to focus on. You explored widely, converged thoughtfully, and selected with care. Before you spend months learning from them, there is one step that can save you all of it: **access testing**.
...
## You Are Still Defining Your People

Even though you have chosen a group, you have not fully defined it. That definition will sharpen as you learn what pain unites them. You started with socio-demographic clues (age, role, setting) and will end up defining your people by **shared unmet needs**.

When those needs start to surface, your early conversations may sound chaotic. Different themes from different people often means you are talking to several pain subgroups at once. That is not failure; it is how discovery works. You will converge again later, using personas and experience maps to find the boundary that pain draws rather than the one demographics drew.
...
- you are prepared to redefine "your people" as patterns emerge
