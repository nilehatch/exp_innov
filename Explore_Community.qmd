...
![Divergent exploration of the community of people to gain insight for better hypotheses of customer pain.](images/221_pain_diverge.svg){.print-w-25 .wrapfig_left_25}
...
::: {.callout-note title="Find Opportunity in Frustration"}
...
**Toolkit Resource**  
See the [Conversation Guide](toolkit/Conversation_Guide.qmd#sec-conversation-guide)  for a ready-to-use protocol, sample prompts, and a notes template.  
<!-- @sec-conversation-guide -->
...
**Toolkit Resource**  
See the [Observation Guide](toolkit/Observation_Guide.qmd#sec-observation-guide) for a ready-to-use guide on how to observe and how to record your observations.
...
**Toolkit Resource**  
See the [Role Play Guide](toolkit/Role_Play_Guide.qmd#sec-role-play-guide) for a ready-to-use guide on how to setup, run, and interpret a role playing experiment.

---

### Surveys  {.method-header #sec-surveys-section}
...
**Toolkit Resource**  
See the [Survey Guide](toolkit/Survey_Guide.qmd#sec-survey-guide) for a ready-to-use guide on survey design principles and traps to avoid.
...
**Toolkit Resource**  
See the [Secondary Research Guide](toolkit/Secondary_Research_Guide.qmd#sec-secondary-research-guide) for a ready-to-use guide on what information to seek and where to look.
