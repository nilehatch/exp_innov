...
## Finding and Engaging Your People {#sec-finding-people}
...
### Show Up Where They Are {#sec-show-up}
...
- [ ] List five physical places and five digital communities where your people gather.
- [ ] Identify the gatekeepers and draft a three or four sentence access script.
- [ ] Plan two low-friction approaches, one physical and one digital, that you can run this week.
- [ ] Prepare a scheduler link and two or three "last time" prompts for the conversations that follow.
- [ ] Decide your success signal before you start, in numbers.

The routes and the messages are in [Getting People to Talk](toolkit/Pain_Guides.qmd#sec-recruiting).
:::

## Ethnographic Exploration

Once you have found and engaged your people, the next step is to immerse yourself in their lived experience. Ethnographers use many tools, but three stand out as especially powerful for entrepreneurs: conversations, observation, and role playing.[^dt]

[^dt]: All three are staples of design practice, and the empathy-first framing is design thinking's contribution before it is this book's [@plattnerDesignThinking2009; @plattnerEmpathyFieldGuide2013]. What changes here is where they are pointed: at a community you chose for expected neglect, rather than at a user group somebody handed you. Each is not just a technique but an exploratory experiment: a structured way to surface evidence of unmet needs.
...
**Contact.** Being in the room with a person. This is yours, and there is no version of this method where it is not. Your AI has read a great deal *about* people. It has never sat with one while they realized something.
...
#### Going Deeper When You Find Something {#sec-going-deeper .unnumbered}

Frustration and emotion are the signal to follow a thread further rather than move on. You already know the first moves: what was hardest, why was it hard, how did you solve it then, why was that solution not awesome. Three more belong at the end of that sequence, and they reach something the others do not.

**"Have you ever bought anything to help with this?"** A purchase is an event, so it keeps you in the same mode as the rest of the conversation. It is also a costly signal: paying money for a difficulty says more than describing one does.

**"Tell me about getting it. What happened the first time you used it?"**

**"Do you still use it?"** — and if not, **"when did you stop, and what happened?"**

An abandonment is an experiment somebody already ran. They tried a solution, it failed, and the reason it failed is a requirement isolated more cleanly than an interview can isolate one. You are being handed a result.

One more, at the very end, after the referral ask and before you thank them: **"What should I have asked you that I didn't?"** It hands the frame over. Your guide encodes what you already suspect, and this is the only question in it that invites somebody to tell you what you left out.

What people build for themselves is worth the same attention. A workaround encodes what a solution had to do, what it failed to do, and what they were willing to put up with instead. Ask what they rigged up, when they started doing it that way, and what it still does not fix.

::: {.trap}
**The averaging question**

*How do you deal with this?* sounds like the same question and is not. It asks someone to summarize across every time it has happened, and what comes back is a tidy general account with the specifics filed off.

Everything else here anchors to a particular day. Keep the anchor:

| asks for an average | asks for an event |
|---|---|
| How do you deal with this? | What did you do *right then*? |
| Do you use anything for it? | What have you **bought** for this? |
| Did it work? | When did you stop using it? |

Purchases, workarounds, and abandonments are all events. That is what makes them reachable without breaking the stance.
:::
...
**Toolkit Resource**  
See the [Conversation Guide](toolkit/Pain_Guides.qmd#sec-conversation) for a ready-to-use protocol, sample prompts, and a notes template.
...
**Toolkit Resource**  
See the [Observation Guide](toolkit/Pain_Guides.qmd#sec-observation) for a ready-to-use guide on how to observe and how to record your observations.
...
**Toolkit Resource**  
See the [Role Play Guide](toolkit/Pain_Guides.qmd#sec-role-play) for a ready-to-use guide on how to setup, run, and interpret a role playing experiment.
...
A respondent can only answer the question you thought to ask. That is fine when you already know what you are looking for — and fatal when you don't. The needs worth building on are the ones your people have stopped noticing: the workaround so old it feels like the weather, the anxiety they would never call a problem. No one writes a survey item for a need nobody has named yet, least of all the person living with it.[^odi]

[^odi]: There is a serious counter-position and it deserves naming. Outcome-driven innovation argues that customers *can* report what they are trying to accomplish, reliably and in a form you can rank, provided you ask about desired outcomes rather than about products or features [@ulwickWhatCustomersWant2005]. Where that holds it is faster than anything in this chapter and you should use it. The wager of this diamond is that the needs with the most room left in them are the ones that have been normalized past the point of being reportable at all.
...
**Toolkit Resource**  
See the [Survey Guide](toolkit/Pain_Guides.qmd#sec-survey) for a ready-to-use guide on survey design principles and traps to avoid.
...
The expensive databases get the attention, and you do not need them. Almost everything an entrepreneur wants is public, once you recognize that it counts as evidence:
...
**Toolkit Resource**  
See the [Secondary Research Guide](toolkit/Pain_Guides.qmd#sec-secondary-research) for a ready-to-use guide on what information to seek and where to look.
...
## When Enough Is Enough {#sec-enough}
...
### What Stopping Actually Means {#sec-reopening .unnumbered}

Be clear about what the entropy signal is and is not. It ends the **broad sweep**. It does not prove that nobody out there would have surprised you, and you should not pretend otherwise: you cannot know that one more conversation would have taught you nothing, and you never will. What you are doing is deciding, under real pressure from time and money and the rest of your life, that further undirected gathering is no longer the best use of the next week.

That is a defensible decision and a provisional one. The question reopens, and it reopens for specific reasons rather than out of a general worry that you should have done more.

::: {.threshold}
**Go back when one of these appears**

- **You need a cell you never filled.** Your experience map has nothing in Thinking or Feeling at a stage that matters, because nobody asked. Go and ask, at that stage, of three or four people.
- **Something load-bearing rests on one person.** A theme, a requirement, or a pain that your whole direction depends on, and one respondent is carrying it.
- **Everyone arrived through the same door.** Referrals compound inside one network, and repetition across one channel is not saturation.
- **A result comes back and you cannot interpret it.** Not because the test was bad, but because you do not know enough about the person who gave it.

Each of these names a question, a target, and a finish line, and that is what makes it a return rather than a relapse. *I need to know what she was thinking at the handoff* is an afternoon. *I should understand my customers better* is a month you will not spend.
:::

Going back is not a verdict on the work you already did. Evidence arrives unevenly, and a gap you can name is worth more than a corpus you never interrogated.
