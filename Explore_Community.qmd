...
::: {.column width="35%" }
<!-- Divergent exploratory experiments through ethnographic and secondary research ... alt text = caption-->
![](images/221_pain_diverge.svg){#fig-triple-diamond-explore style="max-width: 90%; height: auto;"} <!-- style="max-height: 400px;" fig-align="center" } --> <!--  fig-cap-location="top"} -->
:::

::: {.column width="65%"}
<div style="display: table; height: 100%; width: 100%;">
  <div style="display: table-cell; vertical-align: middle;">
<!-- <div style="display: flex; align-items: center; height: 100%; min-height: 250px;">
  <div> -->
