...
<!-- <img src="images/233_solution_test.svg" alt="Confirmatory testing to validate the solution with the customer." class="wrapfig_left_25"/> -->
![Confirmatory testing to validate the solution with the customer.](images/233_solution_test.svg){.print-w-25 .wrapfig_right_25}
...
<!-- ![Confirmatory testing to validate the solution with the customer](images/233_solution_test.svg){width=75% #fig:test-solution} -->
