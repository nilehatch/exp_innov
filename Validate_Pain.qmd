...
::: {.see-demo}
The [Halo Alert pain test](demo/halo-alert-d2-validate.qmd#sec-ha-test-summary) shows all three probes run against one hypothesis, with the [validation detail](demo/halo-alert-d2-validate.qmd#sec-ha-test-validation), the [ouch scores](demo/halo-alert-d2-validate.qmd#sec-ha-test-ouch), and the [willingness-to-pay responses](demo/halo-alert-d2-validate.qmd#sec-ha-test-wtp) recorded separately so you can see how they disagreed.
:::
...
## How Much Evidence Is Enough {#sec-how-much-evidence}
