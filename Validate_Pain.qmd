...
::: {.see-guide}
The [Pain Testing Guide](toolkit/Test_Pain_Guide.qmd) carries the question wording, the logging table, the intercept script, and the micro-survey. This chapter covers what the answers mean and when you have enough of them.
:::
