...
.custom-table {
  ...
  margin-left: auto;
  margin-right: auto;
  table-layout: fixed; /* This helps with uniform column widths */
}
...
.custom-table th:first-child, .custom-table td:first-child {
  width: 25%; /* Adjust the width for the first column */
}

.custom-table th:nth-child(2), .custom-table td:nth-child(2),
.custom-table th:nth-child(3), .custom-table td:nth-child(3) {
  width: 37.5%; /* Adjust the width for the second and third columns */
}

/* Styles for smaller font size in specific cells */
.small-font {
  font-size: 0.9em; /* Smaller font size, adjust as needed */
}

/* Row and column border styles */
.custom-table th, .custom-table td {
  border-right: none;
  border-left: none;
  border-top: none;
...
/* Removing vertical borders and top border */
.custom-table th, .custom-table td {
  border-right: none;
  border-left: none;
  border-top: none;
...
<!-- Place the image above the table -->
<div style="text-align: center;">
  <img src="images/advocacy-v-inquiry-circles.png" alt="A team of competing individuals vs a team of collaborators"style="width: 60%; max-width: 600px; height: auto; margin-bottom: 2px;"/> <!-- Adjust as needed -->
</div>
...
<table class="custom-table">
  <!-- Column headers -->
  <tr>
    <th></th> <!-- Placeholder for the graphic -->
    <th>Advocacy</th>
    <th>Inquiry</th>
  </tr>
  ...
  <tr>
    <td>Concept of decision making</td>
     <td class="small-font">a contest</td>
     <td class="small-font">collaborative problem solving</td>
  </tr>
  <tr>
    <td>Purpose of discussion</td>
     <td class="small-font">persuasion and lobbying</td>
     <td class="small-font">testing and evaluation</td>
  </tr>
  <tr>
    <td>Participant's role</td>
     <td class="small-font">spokespeople</td>
     <td class="small-font">critical thinkers</td>
  </tr>
  <tr>
    <td>Patterns of behavior</td>
    <td class="small-font">strive to persuade others<br>defend your position<br>downplay weaknesses</td>
     <td class="small-font">present balanced arguments<br>remain open to alternatives<br>accept constructive criticism</td>
  </tr>
  <tr>
    <td>Minority Views</td>
     <td class="small-font">discouraged or dismissed</td>
     <td class="small-font">cultivated and valued</td>
  </tr>
  <tr>
    <td>Outcome</td>
     <td class="small-font">winners and losers</td>
     <td class="small-font">collective ownership</td>
  </tr>
</table>
