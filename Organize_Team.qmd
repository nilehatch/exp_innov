...
That is the ordinary ending for these. The market rarely gets the chance to reject them.
:::
...
Equity is an incentive, not a trophy. It is also the main thing a young company can pay with, which means spending it on the past spends it twice: once on work already done, and again on the work it can no longer buy.
...
That is the whole argument for doing this early, and it is why the awkwardness of the conversation is the point rather than a reason to postpone it.
